...
public:
  BinOp(OpType type, std::shared_ptr<Expr> op1, std::shared_ptr<Expr> op2) : type(type), op1(op1), op2(op2){}
  ~BinOp() {}
...
class Parser {
  ...
  std::shared_ptr<Expr> makeExpr(OpType, std::shared_ptr<Expr>, std::shared_ptr<Expr>);
